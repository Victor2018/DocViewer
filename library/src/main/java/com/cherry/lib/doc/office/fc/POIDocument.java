...
import com.cherry.lib.doc.office.fc.hpsf.DocumentSummaryInformation;
import com.cherry.lib.doc.office.fc.hpsf.MutablePropertySet;
import com.cherry.lib.doc.office.fc.hpsf.PropertySet;
import com.cherry.lib.doc.office.fc.hpsf.PropertySetFactory;
import com.cherry.lib.doc.office.fc.hpsf.SummaryInformation;
...
import com.cherry.lib.doc.office.fc.poifs.filesystem.DocumentInputStream;
import com.cherry.lib.doc.office.fc.poifs.filesystem.Entry;
import com.cherry.lib.doc.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.cherry.lib.doc.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.cherry.lib.doc.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.cherry.lib.doc.office.fc.hpsf.WritingNotSupportedException wnse)
        {
