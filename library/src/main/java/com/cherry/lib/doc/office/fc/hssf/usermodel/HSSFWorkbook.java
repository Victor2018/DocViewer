...
import com.cherry.lib.doc.office.fc.POIDocument;
import com.cherry.lib.doc.office.fc.codec.DigestUtils;
import com.cherry.lib.doc.office.fc.ddf.EscherBSERecord;
import com.cherry.lib.doc.office.fc.ddf.EscherBitmapBlip;
import com.cherry.lib.doc.office.fc.ddf.EscherBlipRecord;
...
import com.cherry.lib.doc.office.fc.hssf.formula.SheetNameFormatter;
...
import com.cherry.lib.doc.office.fc.hssf.record.AbstractEscherHolderRecord;
...
import com.cherry.lib.doc.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
import com.cherry.lib.doc.office.fc.hssf.record.ExtendedFormatRecord;
import com.cherry.lib.doc.office.fc.hssf.record.FontRecord;
import com.cherry.lib.doc.office.fc.hssf.record.LabelRecord;
...
import com.cherry.lib.doc.office.fc.hssf.record.RecordFactory;
import com.cherry.lib.doc.office.fc.hssf.record.SSTRecord;
import com.cherry.lib.doc.office.fc.hssf.record.SubRecord;
import com.cherry.lib.doc.office.fc.hssf.record.UnknownRecord;
import com.cherry.lib.doc.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
...
import com.cherry.lib.doc.office.fc.poifs.filesystem.DirectoryNode;
import com.cherry.lib.doc.office.fc.poifs.filesystem.POIFSFileSystem;
import com.cherry.lib.doc.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.cherry.lib.doc.office.fc.ss.util.WorkbookUtil;
 ...
 *
 * @see com.cherry.lib.doc.office.fc.hssf.model.InternalWorkbook
 * @see com.cherry.lib.doc.office.fc.hssf.usermodel.HSSFSheet
 * @author  Andrew C. Oliver (acoliver at apache dot org)
 * @author  Glen Stampoultzis (glens at apache.org)
 * @author  Shawn Laubach (slaubach at apache dot org)
 */
public final class HSSFWorkbook extends POIDocument implements com.cherry.lib.doc.office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.cherry.lib.doc.office.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
    ...
    /**
      ...
      * @see com.cherry.lib.doc.office.fc.hssf.record.LabelRecord
      * @see com.cherry.lib.doc.office.fc.hssf.record.LabelSSTRecord
      * @see com.cherry.lib.doc.office.fc.hssf.record.SSTRecord
      */
     ...
     * @see com.cherry.lib.doc.office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link com.cherry.lib.doc.office.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(com.cherry.lib.doc.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see com.cherry.lib.doc.office.fc.hssf.record.FormatRecord
     * @see com.cherry.lib.doc.office.fc.hssf.record.Record
     */
